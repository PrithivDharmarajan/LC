...
public class CustomerMapFragment extends BaseFragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private Dialog mProviderSearchDialog, mCommentsDialog,mNotificationDialog;
    ...
    private BitmapDescriptor mCurrentLocMarkerBitmapDescriptor;
    private BitmapDescriptor mVanMarkerBitmapDescriptor;
    ...
    private void initView() {
        ...
        BitmapDescriptor mPointMarkerBitmapDescriptor = BitmapDescriptorFactory.fromBitmap(Bitmap.createScaledBitmap(pointBitmap, size30Int, size30Int, false));
    ...
    private void screenAPICall() {
        ...
        if (getActivity() != null) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    if (mAppointmentCardView.getVisibility() == View.VISIBLE || mBookAppointmentBtn.getVisibility() == View.GONE) {
...
//                            if (mProviderArrList.size() > mProviderListInt && mProviderListInt < 1) {
    ...
    public void onRequestSuccess(Object resObj) {
        ...
        if (resObj instanceof PendingDetailsResponse) {
            ...
            if (getActivity() != null) {
                ...
                if (pendingDetailsRes.getResult().getAnotheruser().size() > 0 && pendingDetailsRes.getResult().getAppointments().size() > 0
                    ...
                    if (mOldPendingStatusInt != 2 && mAppointmentDetails.getStatus().equalsIgnoreCase("2")) {
                        ...
                        if (getActivity() != null)
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    alertDismiss(mProviderSearchDialog);
                                    mNotificationDialog = DialogManager.getInstance().showCustomerNotificationPopup(getActivity(),mAppointmentDetails.getDuration(), new InterfaceTwoBtnCallback() {
                                        @Override
                                        public void onNegativeClick() {
                                            UserCancelEntity userCancelEntity = new UserCancelEntity();
                                            userCancelEntity.setAppointmentId(mAppointmentDetails.getAppointmentId());
                                            ...
                                            APIRequestHandler.getInstance().providerCancelAppointmentAPICall(userCancelEntity, CustomerMapFragment.this);
                                            ...
                                            if (getActivity() != null) {
                                                getActivity().runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        mProviderRatingTxt.setText(String.format(Locale.US, "%.1f", Double.parseDouble(userDetails.getRating())));
                            ...
                            public void run() {
                                ...
                                mCommentsDialog = DialogManager.getInstance().showCommentsPopup(getActivity(), new InterfaceEdtBtnCallback() {
                                    ...
                                    public void onPositiveClick(String editStr) {
                                        ...
                                        userRatingInputEntity.setAppointmentId(mAppointmentDetails.getAppointmentId());
        ...
        if (getActivity() != null && (resObj instanceof UserCancelResponse || resObj instanceof AppointmentAcceptResponse)) {
